      ...
      >
        ...
        <section className="relative overflow-hidden">
          <div className="mx-auto grid max-w-6xl gap-8 px-6 pb-16 pt-14 md:grid-cols-2 md:items-center lg:gap-12">
            <div>
              <Badge className="mb-4 bg-slate-900 text-white dark:bg-slate-100 dark:text-slate-900">
                Welcome to your events
              </Badge>

              <h1 className="text-4xl font-bold leading-tight tracking-tight md:text-5xl">
                Join live. Connect in chat.{" "}
                <span className="text-slate-500 dark:text-slate-300">Replay anytime.</span>
              </h1>
                ...
                <div className="grid gap-4">
                  ...
                  >
                    ...
                    <div>
                      ...
                      <p className="text-sm text-slate-600 dark:text-slate-300">
                        Your link takes you straight in — no installs.
                      </p>
                    </div>
                  </div>
                  ...
                  >
                    ...
                    <div>
                      ...
                      <p className="text-sm text-slate-600 dark:text-slate-300">
                        Say hi, react, and ask questions in real time.
                      </p>
                    </div>
                  </div>
                  ...
                  >
                    ...
                    <div>
                      ...
                      <p className="text-sm text-slate-600 dark:text-slate-300">
                        Watch later if you can’t make it live.
                      </p>
                    </div>
                  </div>
                </div>
        ...
        >
          <div className="mx-auto max-w-6xl px-6">
            <div className="mx-auto mb-10 max-w-2xl text-center">
              ...
              <p className="mt-3 text-slate-600 dark:text-slate-300">Three simple steps to a great experience.</p>
            </div>
...
function HowItem({ step, title, desc }: { step: number; title: string; desc: string }) {
  return (
    <motion.div
      ...
      "
    >
      <div className="mb-3 inline-flex h-8 w-8 items-center justify-center rounded-full bg-slate-900 text-white text-sm font-semibold dark:bg-slate-100 dark:text-slate-900">
        {step}
      </div>
