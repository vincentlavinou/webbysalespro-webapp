...
export default function WaitingRoomShimmer({ title }: WaitingRoomShimmerProps) {
  return (
    <div className="max-w-5xl mx-auto px-4 py-8 animate-pulse">
        {title && (
          <p className="text-center text-sm text-gray-400 mb-6">{title}</p>
        )}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-start">
          ...
          <div className="rounded-2xl bg-white/80 border border-white/60 shadow-xl p-6 space-y-5">
            <div className="rounded-xl bg-emerald-100 p-5 text-center space-y-2">
              <div className="h-3 w-24 bg-emerald-200 rounded mx-auto" />
              <div className="h-9 w-48 bg-emerald-200 rounded mx-auto" />
            </div>
            <div className="h-px bg-gray-100" />
            <div className="h-3 w-1/4 bg-gray-200 rounded" />
            ...
            <div className="rounded-xl bg-emerald-50 border border-emerald-100 px-4 py-3 flex items-start gap-3">
              <div className="h-4 w-4 rounded bg-emerald-200 flex-shrink-0 mt-0.5" />
              <div className="space-y-1.5 flex-1">
